...
description: Verify the decision basis, filter options against hard constraints, compare trade-offs, rank viable solutions, and recommend a direction with clear conditions.
