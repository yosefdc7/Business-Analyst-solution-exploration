...
description: Grill the problem and constraints, ground the exploration in reliable sources, and generate materially different solution options without prematurely ranking them.
